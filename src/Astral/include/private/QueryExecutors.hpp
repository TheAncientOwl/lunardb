...
void execute(const Moonlight::API::ParsedQuery& parsed_query, const Astral::API::Config& config); \
}
...
void Specialization::execute(const Moonlight::API::ParsedQuery& parsed_query, const Astral::API::Config& config)
...
using Executor = void(*)(const Moonlight::API::ParsedQuery&, const Astral::API::Config&);
