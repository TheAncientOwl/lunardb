...
#define EXPECT_FAIL(query) \
    EXPECT_THROW(API::ParsedQuery::from(query).get<View>(), std::runtime_error)
...
TEST(ViewParserTest, fail01)
{
    ...
    // missing structure
    EXPECT_FAIL(
        R"(view ViewName as select from StructureName             )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
    ...
    EXPECT_FAIL(
        R"(view ViewName as select from structure                                  )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
    ...
    EXPECT_FAIL(
        R"(view ViewName as select from structure Structure Name  )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
    ...
    // whitespace in structure view name
    EXPECT_FAIL(
        R"(view View Name as select from structure StructureName  )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
    ...
    // missing as
    EXPECT_FAIL(
        R"(view ViewName select from structure StructureName      )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
    ...
    // missing view name
    EXPECT_FAIL(
        R"(view as select from structure StructureName            )"
        R"(     where (                                           )"
        R"(         name like "*escu"                             )"
        R"(         and salary between 5500 and 6000              )"
        R"(         or (                                          )"
